...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans relative overflow-hidden text-slate-300">
      ...
      {/* Background Orbs */}
      <div className="absolute top-[-20%] right-[-10%] w-[50%] h-[50%] rounded-full bg-teal-600/10 blur-[120px] pointer-events-none" />
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 flex flex-col items-center">
        ...
        <p className="mt-2 text-center text-sm text-slate-400">
          Don't have an account? <Link to="/signup" className="font-semibold text-teal-400 hover:text-teal-300 transition-colors">Sign up for free</Link>
        </p>
      </div>
